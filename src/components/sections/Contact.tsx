...
export function Contact() {
  ...
  const handleCopyEmail = async () => {
    try {
      await navigator.clipboard.writeText("agenciasuiza8@gmail.com");
      setCopied(true);
      ...
      <div className="max-w-content mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 lg:items-start">
          ...
          <div>
            ...
            <div className="relative w-full max-w-xs aspect-square rounded-2xl overflow-hidden border-2 border-border hover:border-accent/40 transition-colors">
              <Image
          ...
          <div className="space-y-4 lg:pt-[180px]">
            <a
